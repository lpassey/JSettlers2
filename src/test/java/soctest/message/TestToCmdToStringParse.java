...
public class TestToCmdToStringParse
{
    ...
    private static final Object[][] TOCMD_TOSTRING_COMPARES =
        new Object[][]{
            new Object[]{new SOCAcceptOffer( "ga", 2, 3 ), "1039|ga,2,3", "SOCAcceptOffer:game=ga|accepting=2|offering=3"},
            new Object[]{new SOCAcceptOffer( "ga", -2, 3 ), "1039|ga,-2,3", "SOCAcceptOffer:game=ga|accepting=-2|offering=3"},
            // TODO? SOCAdminPing
            new Object[]{new SOCAdminReset(), "1065", "SOCAdminReset:"},
            // TODO SOCAuthRequest
            new Object[]{
            ...
            new Object[]{new SOCBCastTextMsg( "msg text" ), "1062|msg text", "SOCBCastTextMsg:text=msg text"},
            new Object[]{
                new SOCBoardLayout
                    ( "ga",
            ...
            new Object[]{new SOCBuildRequest( "ga", SOCPlayingPiece.CITY ), "1043|ga,2", "SOCBuildRequest:game=ga|pieceType=2"},
            new Object[]{new SOCBuyDevCardRequest( "ga" ), "1045|ga", "SOCBuyDevCardRequest:game=ga"},
            // v1.x was SOCBuyCardRequest:
            new Object[]{new SOCBuyDevCardRequest( "ga" ), "1045|ga", "SOCBuyCardRequest:game=ga", OPT_PARSE_ONLY},
            new Object[]{new SOCCancelBuildRequest( "ga", SOCPlayingPiece.CITY ), "1044|ga,2", "SOCCancelBuildRequest:game=ga|pieceType=2"},
            new Object[]{new SOCChangeFace( "ga", 3, 7 ), "1058|ga,3,7", "SOCChangeFace:game=ga|playerNumber=3|faceId=7"},
            new Object[]{new SOCChannelMembers( "cha", Arrays.asList( "player0", "droid 1", "robot 2", "debug" ) ), "1002|cha,player0,droid 1,robot 2,debug", "SOCChannelMembers:channel=cha|members=[player0, droid 1, robot 2, debug]"},
            new Object[]{new SOCChannelMembers( "cha", Arrays.asList( "m" ) ), "1002|cha,m", "SOCChannelMembers:channel=cha|members=[m]"},  // shortest list
            // v1.x was SOCMembers, slightly different list format:
            new Object[]{new SOCChannelMembers( "cha", Arrays.asList( "player0", "droid 1", "debug" ) ), "1002|cha,player0,droid 1,debug", "SOCMembers:channel=cha|members=player0,droid 1,debug", OPT_PARSE_ONLY},
            // TODO SOCChannels
            new Object[]{
            ...
            new Object[]{new SOCChoosePlayer( "ga", 2 ), "1035|ga,2", "SOCChoosePlayer:game=ga|choice=2"},
            new Object[]{
            ...
            new Object[]{new SOCClearOffer( "ga", 2 ), "1038|ga,2", "SOCClearOffer:game=ga|playerNumber=2"},
            new Object[]{new SOCClearTradeMsg( "ga", -1 ), "1042|ga,-1", "SOCClearTradeMsg:game=ga|playerNumber=-1"},
            // TODO? SOCCreateAccount
            new Object[]{new SOCDebugFreePlace( "ga", 3, true ), "1087|ga,3,0,1", "SOCDebugFreePlace:game=ga|playerNumber=3|pieceType=ROAD|coord=0x1"},
            new Object[]{new SOCDebugFreePlace( "ga", 3, SOCPlayingPiece.SETTLEMENT, 0x405 ), "1087|ga,3,1,1029", "SOCDebugFreePlace:game=ga|playerNumber=3|pieceType=SETTLEMENT|coord=0x405"},
            new Object[]{new SOCDeleteChannel( "ch name" ), "1007|ch name", "SOCDeleteChannel:channel=ch name"},
            new Object[]{new SOCDeleteGame( "ga" ), "1015|ga", "SOCDeleteGame:game=ga"},
            new Object[]{new SOCDevCardAction( "ga", 3, SOCDevCardAction.ADD_OLD, 6 ), "1046|ga,3,3,6", "SOCDevCardAction:game=ga|playerNum=3|actionType=ADD_OLD|cardType=6"},
            new Object[]{new SOCDevCardAction( "ga", 3, SOCDevCardAction.ADD_NEW, 9 ), "1046|ga,3,2,9", "SOCDevCardAction:game=ga|playerNum=3|actionType=ADD_NEW|cardType=9"},
            new Object[]{new SOCDevCardAction( "ga", 3, SOCDevCardAction.DRAW, 5 ), "1046|ga,3,0,5", "SOCDevCardAction:game=ga|playerNum=3|actionType=DRAW|cardType=5"},
            new Object[]{new SOCDevCardAction( "ga", 3, SOCDevCardAction.PLAY, 9 ), "1046|ga,3,1,9", "SOCDevCardAction:game=ga|playerNum=3|actionType=PLAY|cardType=9"},
            // v1.x was SOCDevCard:
            new Object[]{new SOCDevCardAction( "ga", 3, SOCDevCardAction.DRAW, 2 ), "1046|ga,3,0,2", "SOCDevCard:game=ga|playerNum=3|actionType=0|cardType=2", OPT_PARSE_ONLY},
            new Object[]{new SOCDevCardAction( "ga", 3, SOCDevCardAction.DRAW, SOCDevCardConstants.KNIGHT ), null, "SOCDevCard:game=ga|playerNum=3|actionType=0|cardType=0", OPT_PARSE_ONLY},
            new Object[]{
                // v2.x end-of-game form
                new SOCDevCardAction( "ga", 3, SOCDevCardAction.ADD_OLD, Arrays.asList( 5, 4 ) ),
                "1046|ga,3,3,5,4",
                "SOCDevCardAction:game=ga|playerNum=3|actionType=ADD_OLD|cardTypes=[5, 4]"
            },
            new Object[]{new SOCDevCardCount( "ga", 22 ), "1047|ga,22", "SOCDevCardCount:game=ga|numDevCards=22"},
            new Object[]{new SOCDiceResult( "ga", 9 ), "1028|ga,9", "SOCDiceResult:game=ga|param=9"},
            new Object[]{
            ...
            new Object[]{new SOCDiscardRequest( "ga", 4 ), "1029|ga,4", "SOCDiscardRequest:game=ga|numDiscards=4"},
            new Object[]{new SOCEndTurn( "ga" ), "1032|ga", "SOCEndTurn:game=ga"},
            new Object[]{new SOCFirstPlayer( "ga", 2 ), "1054|ga,2", "SOCFirstPlayer:game=ga|playerNumber=2"},
            new Object[]{new SOCGameElements( "ga", GEType.CURRENT_PLAYER, 1 ), "1096|ga|4|1", "SOCGameElements:game=ga|CURRENT_PLAYER=1"},
            new Object[]{
                new SOCGameElements
                ...
                "SOCGameElements:game=ga|DEV_CARD_COUNT=25,ROUND_COUNT=2,FIRST_PLAYER=1,LONGEST_ROAD_PLAYER=-1,LARGEST_ARMY_PLAYER=-1"
            },
            new Object[]{new SOCGameMembers( "ga", Arrays.asList( "player0", "droid 1", "robot 2", "debug" ) ), "1017|ga,player0,droid 1,robot 2,debug", "SOCGameMembers:game=ga|members=[player0, droid 1, robot 2, debug]"},
            new Object[]{new SOCGameMembers( "ga", Arrays.asList( "p" ) ), "1017|ga,p", "SOCGameMembers:game=ga|members=[p]"},  // shortest list
            // v1.x: slightly different list format, same message type name
            new Object[]{new SOCGameMembers( "ga", Arrays.asList( "player0", "droid 1", "robot 2", "debug" ) ), "1017|ga,player0,droid 1,robot 2,debug", "SOCGameMembers:game=ga|members=player0,droid 1,robot 2,debug", OPT_PARSE_ONLY},
            // TODO SOCGameOptionGetDefaults
            new Object[]{new SOCGameOptionGetInfos( null, false, false ), "1081|-", "SOCGameOptionGetInfos:options=-"},
            new Object[]{new SOCGameOptionGetInfos( null, true, false ), "1081|-,?I18N", "SOCGameOptionGetInfos:options=-,?I18N"},
            new Object[]{new SOCGameOptionGetInfos( null, true, true ), "1081|?I18N", "SOCGameOptionGetInfos:options=?I18N"},
            new Object[]{new SOCGameOptionGetInfos( Arrays.asList( "SC", "PLP" ), false, false ), "1081|SC,PLP", "SOCGameOptionGetInfos:options=SC,PLP"},
            new Object[]{new SOCGameOptionGetInfos( Arrays.asList( "SC", "PLP" ), true, false ), "1081|SC,PLP,?I18N", "SOCGameOptionGetInfos:options=SC,PLP,?I18N"},
            new Object[]{
            ...
            new Object[]{new SOCGameState( "ga", 20 ), "1025|ga,20", "SOCGameState:game=ga|state=20"},
            new Object[]{new SOCGameStats( "ga", new int[]{10, 4, 3, 2}, new boolean[]{false, true, true, true} ), "1061|ga,10,4,3,2,false,true,true,true", "SOCGameStats:game=ga|10|4|3|2|false|true|true|true"},
            ...
            new Object[]{new SOCImARobot( "robot 7", "**", "soc.robot.SomeExample" ), "1022|robot 7,**,soc.robot.SomeExample", "SOCImARobot:nickname=robot 7|cookie=**|rbclass=soc.robot.SomeExample"},
            new Object[]{
            ...
            new Object[]{new SOCJoinChannel( "m name", "", "-", "ch name" ), "1004|m name,\t,-,ch name", "SOCJoinChannel:nickname=m name|password empty|host=-|channel=ch name"},
            new Object[]{new SOCJoinChannel( "m name", "***", "-", "ch name" ), "1004|m name,***,-,ch name", "SOCJoinChannel:nickname=m name|password=***|host=-|channel=ch name"},
            // v1.x was SOCJoin:
            new Object[]{new SOCJoinChannel( "m name", "", "-", "ch name" ), "1004|m name,\t,-,ch name", "SOCJoin:nickname=m name|password empty|host=-|channel=ch name", OPT_PARSE_ONLY},
            new Object[]{new SOCJoinChannelAuth( "m name", "ch name" ), "1020|m name,ch name", "SOCJoinChannelAuth:nickname=m name|channel=ch name"},
            // v1.x was SOCJoinAuth:
            new Object[]{new SOCJoinChannelAuth( "m name", "ch name" ), "1020|m name,ch name", "SOCJoinAuth:nickname=m name|channel=ch name", OPT_PARSE_ONLY},
            new Object[]{new SOCJoinGame( "testp2", "", SOCMessage.EMPTYSTR, "ga" ), "1013|testp2,\t,\t,ga", "SOCJoinGame:nickname=testp2|password empty|host=\t|game=ga"},
            new Object[]{new SOCJoinGameAuth( "ga" ), "1021|ga", "SOCJoinGameAuth:game=ga"},
            new Object[]{new SOCJoinGameAuth( "ga", 20, 21, new int[]{-2, 1, 3, 0} ), "1021|ga,20,21,S,-2,1,3,0", "SOCJoinGameAuth:game=ga|bh=20|bw=21|vs=[-2, 1, 3, 0]"},
            new Object[]{new SOCLargestArmy( "ga", 2 ), "1067|ga,2", "SOCLargestArmy:game=ga|playerNumber=2"},
            new Object[]{new SOCLastSettlement( "ga", 2, 0x405 ), "1060|ga,2,1029", "SOCLastSettlement:game=ga|playerNumber=2|coord=405"},
            new Object[]{new SOCLeaveAll(), "1008", "SOCLeaveAll:"},
            new Object[]{new SOCLeaveChannel( "m name", "-", "ch name" ), "1006|m name,-,ch name", "SOCLeaveChannel:nickname=m name|host=-|channel=ch name"},
            // v1.x was SOCLeave:
            new Object[]{new SOCLeaveChannel( "m name", "-", "ch name" ), "1006|m name,-,ch name", "SOCLeave:nickname=m name|host=-|channel=ch name", OPT_PARSE_ONLY},
            new Object[]{new SOCLeaveGame( "testp2", "-", "ga" ), "1011|testp2,-,ga", "SOCLeaveGame:nickname=testp2|host=-|game=ga"},
            new Object[]{
            ...
            new Object[]{new SOCLongestRoad( "ga", 2 ), "1066|ga,2", "SOCLongestRoad:game=ga|playerNumber=2"},
            new Object[]{
            ...
            new Object[]{
                ...
                "SOCMovePiece:game=ga|pn=1|pieceType=SHIP|fromCoord=0xc06|toCoord=0xf06"
            },
            new Object[]{new SOCMoveRobber( "ga", 3, 0x305 ), "1034|ga,3,773", "SOCMoveRobber:game=ga|playerNumber=3|coord=305"},
            new Object[]{new SOCNewChannel( "ch name" ), "1001|ch name", "SOCNewChannel:channel=ch name"},
            new Object[]{new SOCNewGame( "ga" ), "1016|ga", "SOCNewGame:game=ga"},
            new Object[]{
            ...
            new Object[]{new SOCPickResources( "ga", new SOCResourceSet( 0, 1, 0, 0, 1, 0 ) ), "1052|ga,0,1,0,0,1", "SOCPickResources:game=ga|resources=clay=0|ore=1|sheep=0|wheat=0|wood=1|unknown=0"},
            new Object[]{new SOCPickResources( "ga", 0, 1, 0, 0, 1 ), "1052|ga,0,1,0,0,1", "SOCPickResources:game=ga|resources=clay=0|ore=1|sheep=0|wheat=0|wood=1|unknown=0"},
            // v1.x was SOCDiscoveryPick:
            new Object[]{new SOCPickResources( "ga", 0, 1, 0, 0, 1 ), "1052|ga,0,1,0,0,1", "SOCDiscoveryPick:game=ga|resources=clay=0|ore=1|sheep=0|wheat=0|wood=1|unknown=0", OPT_PARSE_ONLY},
            new Object[]{new SOCPickResourceType( "ga", SOCResourceConstants.SHEEP ), "1053|ga,3", "SOCPickResourceType:game=ga|resType=3"},
            // v1.x was SOCMonopolyPick:
            new Object[]{new SOCPickResourceType( "ga", SOCResourceConstants.WHEAT ), "1053|ga,4", "SOCMonopolyPick:game=ga|resource=4", OPT_PARSE_ONLY},
            new Object[]{new SOCPieceValue( "ga", SOCPlayingPiece.VILLAGE, 0xa06, 4, 0 ), "1095|ga,5,2566,4,0", "SOCPieceValue:game=ga|pieceType=5|coord=2566|pv1=4|pv2=0"},
            new Object[]{new SOCPlayDevCardRequest( "ga", SOCDevCardConstants.KNIGHT ), "1049|ga,9", "SOCPlayDevCardRequest:game=ga|devCard=9"},
            new Object[]{new SOCPlayerElement( "ga", 1, SOCPlayerElement.SET, 105, 1 ),
                "1024|ga,1,100,105,1",
                "SOCPlayerElement:game=ga|playerNum=1|actionType=SET|elementType=STARTING_LANDAREAS|amount=1"},
            new Object[]{new SOCPlayerElement( "ga", 2, SOCPlayerElement.LOSE, 4, 1, true ),
                "1024|ga,2,102,4,1,Y",
                "SOCPlayerElement:game=ga|playerNum=2|actionType=LOSE|elementType=WHEAT|amount=1|news=Y"},
            new Object[]{
                new SOCPlayerElements( "ga", 2, SOCPlayerElement.GAIN, new SOCResourceSet( 1, 0, 2, 3, 4, 0 ) ),
                "1086|ga|2|101|1|1|3|2|4|3|5|4",
                "SOCPlayerElements:game=ga|playerNum=2|actionType=GAIN|CLAY=1,SHEEP=2,WHEAT=3,WOOD=4"
            },
            new Object[]{
                ...
                "SOCPlayerElements:game=ga|playerNum=2|actionType=SET|LAST_SETTLEMENT_NODE=69,NUMKNIGHTS=0,ROADS=13"
            },
            new Object[]{
            ...
            new Object[]{new SOCPotentialSettlements( "ga", 2, new ArrayList<Integer>() ), "1057|ga,2", "SOCPotentialSettlements:game=ga|playerNum=2|list=(empty)"},
            new Object[]{new SOCPotentialSettlements( "ga", 3, new ArrayList<Integer>( Arrays.asList( 0xc04, 0xe05, 0x60a ) ) ), "1057|ga,3,3076,3589,1546", "SOCPotentialSettlements:game=ga|playerNum=3|list=c04 e05 60a "},
            // same as above, but no trailing space in toString's list:
            new Object[]{new SOCPotentialSettlements( "ga", 3, new ArrayList<Integer>( Arrays.asList( 0xc04, 0xe05, 0x60a ) ) ), "1057|ga,3,3076,3589,1546", "SOCPotentialSettlements:game=ga|playerNum=3|list=c04 e05 60a", OPT_PARSE_ONLY},
            ...
            new Object[]{
                ...
                new SOCPotentialSettlements
                    ( "ga", 3, null, 1,
                        ...
                        new int[][]{new int[]{0xc07, -0xc0b, 0xd07, -0xd0b, 0xe04, -0xe0a, 0xa03}} ),
            ...
            new Object[]{
                ...
                new SOCPotentialSettlements
                    ( "ga", 3, new ArrayList<Integer>(), 0,
                        new HashSet[]{null, new HashSet( Arrays.asList( 0xa0f ) ), new HashSet( Arrays.asList( 0x60a ) )},
                        new int[][]{new int[]{0xc07, -0xc0b, 0xe04, -0xe0a}, new int[]{}, new int[]{0xd07, -0xd0b, 0xa03}, new int[]{}} ),
            ...
            new Object[]{new SOCPutPiece( "ga", 3, 0, 1034 ),
                "1009|ga,3,0,1034",
                "SOCPutPiece:game=ga|playerNumber=3|pieceType=ROAD|coord=0x40a"},
            new Object[]{new SOCRejectConnection( "reason msg" ), "1059|reason msg", "SOCRejectConnection:reason msg"},
            new Object[]{new SOCRejectOffer( "ga", 2 ), "1037|ga,2", "SOCRejectOffer:game=ga|playerNumber=2"},
            new Object[]{new SOCRemovePiece( "ga", 2, 3, 0xe04 ),
                "1094|ga,2,3,3588",
                "SOCRemovePiece:game=ga|pn=2|pieceType=SHIP|coord=3588"},
            new Object[]{
            ...
            new Object[]{new SOCResetBoardAuth( "ga", 3, 2 ), "1074|ga,3,2", "SOCResetBoardAuth:game=ga|rejoinPN=3|requestingPN=2"},
            // parse from old field names, which are in some STACSettlers soclog files:
            new Object[]{new SOCResetBoardAuth( "ga", 3, 2 ), "1074|ga,3,2", "SOCResetBoardAuth:game=ga|param1=3|param2=2", OPT_PARSE_ONLY},
            new Object[]{new SOCResetBoardReject( "ga" ), "1077|ga", "SOCResetBoardReject:game=ga"},
            new Object[]{new SOCResetBoardRequest( "ga" ), "1073|ga", "SOCResetBoardRequest:game=ga"},
            new Object[]{new SOCResetBoardVote( "ga", 3, true ), "1076|ga,3,1", "SOCResetBoardVote:game=ga|pn=3|vote=1"},
            // parse from old field names, which are in some STACSettlers soclog files:
            new Object[]{new SOCResetBoardVote( "ga", 3, true ), "1076|ga,3,1", "SOCResetBoardVote:game=ga|param1=3|param2=1", OPT_PARSE_ONLY},
            new Object[]{new SOCResetBoardVoteRequest( "ga", 3 ), "1075|ga,3", "SOCResetBoardVoteRequest:game=ga|param=3"},
            new Object[]{new SOCResourceCount( "ga", 3, 11 ), "1063|ga,3,11", "SOCResourceCount:game=ga|playerNumber=3|count=11"},
            new Object[]{new SOCRevealFogHex( "ga", 3340, SOCBoard.WOOD_HEX, 12 ), "10001|ga,3340,5,12", "SOCRevealFogHex:game=ga|hexCoord=3340|hexType=5|diceNum=12"},
            new Object[]{new SOCRobotDismiss( "ga" ), "1056|ga", "SOCRobotDismiss:game=ga"},
            new Object[]{new SOCRollDice( "ga" ), "1031|ga", "SOCRollDice:game=ga"},
            new Object[]{new SOCRollDicePrompt( "ga", 3 ), "1072|ga,3", "SOCRollDicePrompt:game=ga|playerNumber=3"},
            // can ignore unused SOCRollDiceRequest
            new Object[]{new SOCScenarioInfo( new ArrayList<>( SCENS_KEY_LIST ), false ), "1101|[|KEY1|KEY2", "SOCScenarioInfo:p=[|p=KEY1|p=KEY2", OPT_SKIP_PARSE},
            new Object[]{new SOCScenarioInfo( new ArrayList<>( SCENS_KEY_LIST ), true ), "1101|[|KEY1|KEY2|?", "SOCScenarioInfo:p=[|p=KEY1|p=KEY2|p=?", OPT_SKIP_PARSE},
            new Object[]{new SOCScenarioInfo( "KEY3", true ), "1101|KEY3|0|-2", "SOCScenarioInfo:key=KEY3|minVers=0|lastModVers=MARKER_KEY_UNKNOWN", OPT_SKIP_PARSE},
            new Object[]{
            ...
            new Object[]{new SOCServerPing( 42 ), "9999|42", "SOCServerPing:sleepTime=42"},
            new Object[]{new SOCSetPlayedDevCard( "ga", 2, false ), "1048|ga,2,false", "SOCSetPlayedDevCard:game=ga|playerNumber=2|playedDevCard=false"},
            new Object[]{new SOCSetSeatLock( "ga", 2, SeatLockState.LOCKED ),
                "1068|ga,2,LOCKED",
                "SOCSetSeatLock:game=ga|playerNumber=2|state=LOCKED"},
            new Object[]{
            ...
            new Object[]{new SOCSetTurn( "ga", 2 ), "1055|ga,2", "SOCSetTurn:game=ga|param=2"},
            new Object[]{new SOCSimpleAction( "ga", 3, 1, 22 ), "1090|ga,3,1,22,0", "SOCSimpleAction:game=ga|pn=3|actType=1|v1=22|v2=0"},
            new Object[]{new SOCSimpleRequest( "ga", 2, 1001, 2562 ), "1089|ga,2,1001,2562,0", "SOCSimpleRequest:game=ga|pn=2|reqType=1001|v1=2562|v2=0"},
            new Object[]{new SOCSimpleRequest( "ga", 2, 1001, 2562, 7 ), "1089|ga,2,1001,2562,7", "SOCSimpleRequest:game=ga|pn=2|reqType=1001|v1=2562|v2=7"},
            new Object[]{new SOCSitDown( "ga", "testp2", 2, false ), "1012|ga,testp2,2,false", "SOCSitDown:game=ga|nickname=testp2|playerNumber=2|robotFlag=false"},
            new Object[]{new SOCStartGame( "ga", SOCGame.START1A ), "1018|ga,5", "SOCStartGame:game=ga|gameState=5"},
            new Object[]{new SOCStatusMessage( "simple ok status" ), "1069|simple ok status", "SOCStatusMessage:status=simple ok status"},
            new Object[]{new SOCStatusMessage( 11, "nonzero status text" ), "1069|11,nonzero status text", "SOCStatusMessage:sv=11|status=nonzero status text"},
            new Object[]{new SOCSVPTextMessage( "ga", 3, 2, "settling a new island", true ), "1097|ga,3,2,settling a new island", "SOCSVPTextMessage:game=ga|pn=3|svp=2|desc=settling a new island"},
            new Object[]{new SOCTimingPing( "ga" ), "1088|ga", "SOCTimingPing:game=ga"},
            new Object[]{new SOCTurn( "ga", 3, 0 ), "1026|ga,3", "SOCTurn:game=ga|playerNumber=3"},
            new Object[]{new SOCTurn( "ga", 3, SOCGame.ROLL_OR_CARD ), "1026|ga,3,15", "SOCTurn:game=ga|playerNumber=3|gameState=15"},
            new Object[]{
    ...
    public void testStripAttribNames()
    {
        final String[][] expected_actual =
            new String[][]{
                new String[]{"", ""},
                new String[]{"xyz", "xyz"},
                new String[]{"xyz", "param=xyz"},
                new String[]{"xyz,abc", "xyz|p=abc"},
                new String[]{"xyz,abc", "param=xyz|p=abc"},
                // game name contains '='
                new String[]{"fancy=game==name,abc,xyz", "game=fancy=game==name|p1=abc|p2=xyz"},
                // other param contains '='
                new String[]{"ga,usual_name,==fancy=name", "game=ga|pn1=usual_name|pn2===fancy=name"},
                new String[]{"ga_special=name,[player==0, droid 1, robot 2, debug]",
