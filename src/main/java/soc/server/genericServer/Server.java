 ...
 *  of {@link InboundMessageQueue} will call {@link SOCMessageDispatcher#dispatch(SOCMessage, Connection)}
...
public abstract class Server extends Thread implements Serializable, Cloneable
{
     ...
     * {@code Treater} thread which calls {@link SOCMessageDispatcher#dispatch(SOCMessage, Connection)}.
     *<P>
     ...
     * {@link Connection#getRemoteVersion()}.
     ...
     * {@link Connection#connect( boolean )} is called at the start of this method.
     *<P>
     ...
     *
     * @param cvers Client version number, from {@link Connection#getRemoteVersion()}.
     * @see #clientVersionRem(int)
...
//    }
     ...
     *
     * @param m SOCmessage string, generated by {@link soc.message.SOCMessage#toCmd()}
     * @param vmin Minimum version, as returned by {@link Connection#getRemoteVersion()},
