...
public class SwingMainDisplay extends JPanel implements MainDisplay
{
     ...
     * like in {@link MainDisplayBaseImpl}'s main panel.
     ...
     */
    static final String MESSAGE_PANEL = "message";
     ...
     * @since 1.1.00
     */
    static final String CONNECT_OR_PRACTICE_PANEL = "connOrPractice";
     ...
     * @since 2.0.00
     */
    protected static boolean didScaleUIManagerFonts;
     ...
     * @since 2.0.00
     */
    protected static boolean hasDeterminedOSColors;
     ...
     * @since 2.0.00
     */
    protected static boolean isOSColorHighContrast;  // TODO later enhancement: + isOSDarkBackground
...
//    protected SOCConnectOrPracticePanel connectOrPracticePane;
    ...
    protected SOCConnectPanel connectPanel;
     ...
     * @since 2.7.00
     */
    protected final Hashtable<String, NewGameOptionsFrame> gameInfoFrames = new Hashtable<>();
    ...
    protected GridBagLayout mainGBL;

    /** Constraints for {@link #mainGBL} */
    protected GridBagConstraints mainGBC;
     ...
     * @since 1.1.19
     */
    protected boolean mainPaneLayoutIsDone, mainPaneLayoutIsDone_hasChannels;
...
//    private JLabel localTCPServerLabel;
     ...
     * @since 1.1.00
     */
    protected JLabel versionOrlocalTCPPortLabel;
     ...
     */
    public SwingMainDisplay( final SOCPlayerClient client, final int displayScaleFactor )
...
//        this.hasConnectOrPractice = hasConnectOrPractice;
     ...
     * {@inheritDoc}
     *<P>
     * Uses {@link NotifyDialog#createAndShow(MainDisplayBaseImpl, Frame, String, String, boolean)}
...
//        messageLabel.setText(strings.get("pcli.message.connecting.serv"));  // "Connecting to server..."
     ...
     */
    protected void initMainPanelLayout(final boolean isStatusRow, final SOCFeatureSet feats)
            throws IllegalArgumentException
    {
...
//    {
//        // Only to make abstract base class happy.
...
//                    || (target == buttonDisconnect)
     ...
     * @since 1.1.06
     */
    protected boolean guardedActionPerform_channels(Object target)
    {
        String ch = null;
...
//                client.practiceNickname = n;
     ...
     * @since 2.3.00
     */
    protected String checkNameFormat(final String n)
    {
        String errMsg = null;
    ...
    @Override
    public void resetGameOptionDefaultsTimeoutTask()
    {
...
//            } else
    ...
    public SOCPlayerInterface findAnyActiveGame(boolean fromPracticeServer)
    {
        ...
        Collection<String> gameNames = playerInterfaces.keySet();
    ...
    {
        return (null != findAnyActiveGame( false ));
    }
...
//            }
            ...
            (final SOCGame game, final int[] layoutVS, final Map<String, Object> localPrefs)
    {
        ...
        final SOCPlayerInterface pi = new SOCPlayerInterface
                (game.getName(), this, game, layoutVS, localPrefs);
...
//                    ( MainDisplayBaseImpl.this,
//                     null,
//                     strings.get("mainDisplay.localserver.dialog", tportStr),
...
//
//        // Set label
//        localTCPServerLabel.setText(strings.get("mainDisplay.localserver.running"));  // "Server is Running. (Click for info)"
//        localTCPServerLabel.setFont(getFont().deriveFont(Font.BOLD));
//        localTCPServerLabel.addMouseListener(mouseListener);
//        versionOrlocalTCPPortLabel.setText(strings.get("mainDisplay.localserver.port", tportStr));  // "Port: {0}"
//        versionOrlocalTCPPortLabel.setToolTipText
//            (strings.get("mainDisplay.localserver.running.tip", tportStr, Version.version(), Version.buildnum()));
...
//                        (strings.get("mainDisplay.main.title.localserver", Version.version(), tportStr));
...
//    }
    ...
    /**
     * A game or channel in the displayed {@link MainDisplayBaseImpl#gmlist} or {@link MainDisplayBaseImpl#chlist}.
     ...
     * @since 2.0.00
     */
    protected static class JoinableListItem
    {
     ...
     * @since 1.1.07
     */
    protected static class GameOptionsTimeoutTask extends TimerTask
    {
     ...
     * @since 1.1.07
     */
    protected static class GameOptionDefaultsTimeoutTask extends TimerTask
    {
        public MainDisplay mainDisplay;
        public ServerGametypeInfo srvOpts;
        public boolean forPracticeServer;

        public GameOptionDefaultsTimeoutTask ( MainDisplay c, ServerGametypeInfo opts, boolean forPractice)
        {
            mainDisplay = c;
            srvOpts = opts;
        ...
        public void run()
        {
            mainDisplay.resetGameOptionDefaultsTimeoutTask();  // Clear reference to this soon-to-expire obj
