 ...
 *<P>
 * During game state {@link soc.game.GameState#PLAY1 PLAY1}, this is a build request during the client player's turn:
 ...
 * or newer, and game state is {@link soc.game.GameState#PLAY1 PLAY1} or
 * {@link soc.game.GameState#SPECIAL_BUILDING SPECIAL_BUILDING}:
